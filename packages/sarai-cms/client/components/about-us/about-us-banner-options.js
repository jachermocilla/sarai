...
Template.AboutUsBannerOptions.created = function() {
  this.uploadedFile = ''
}

Template.AboutUsBannerOptions.onRendered(() => {
...
Template.AboutUsBannerOptions.events({
...
Template.AboutUsBannerOptions.helpers({
