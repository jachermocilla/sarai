if (Services.find().count() === 0) {
    ...
    info: [
    	{
    		label: 'Crops :',
    		text: ['Rice, Corn, Banana, Coconut, Coffee, Cacao']
    	},
    	{
    		label: 'Experts :',
    		text: ['Dr. Felino A. Lansigan, CA, UPLB']
    	},
    	{
    		label: 'URA :',
    		text: ['Roinand Aguila', 'Monina Gazelle Charina Carandang', 'Jeyneth Ann Mariano']
    	}
    ],
    projectLeaders: [],
    mediaLink: '/Services/alerts-and-advisories.jpg',
    mediaType: 'image',
	...
	Services.insert({
	    ...
	    info: [
	    	...
	    	{
	    		label: 'URA :',
	    		text: ['Karen Berido Burdeos', 'Julia Dalagan', 'John Christopher Lorenzo', 'Marilyn Yere']
	    	}
	    ],
	    projectLeaders: ['Project 1, Dr. Felino Lansigan, Project Leader'],
	    mediaLink: '/Services/ICM.jpg',
	    mediaType: 'image',
	    mediasubtext: 'Click here to view the crop monitoring application.',
	    mediasubtextlink: 'http://159.203.253.36:8080/index.php',
	    col1Title: 'The Challenge',
	    col1Text: '<p>Reliable and timely crop forecasts are essential elements in food security assessment of a region at any given period.</p>',
	    col2Title: 'Solution',
	    col2Text: '<p>Use and applications of advances in Science and Technology facilitate the determination of cropped area and yield forecasts to provide reliable crop forecasts on a regular basis.</p>',
	    share: [
	        {
	            class_name: 'fb',
	...
	Services.insert({
	    ...
	    info: [
	    	...
	    	{
	    		label: 'Experts :',
	    		text: ['Prof. Nel Altoveros, CAS, UPLB']
	    	},
	    	{
	    		label: 'URA :',
	    		text: ['Janah Monsanto']
	...
	Services.insert({
	    ...
	    info: [
	    	...
	    	{
	    		label: 'Experts :',
	    		text: ['Prof. Melvin Ebuenga, NCPC, UPLB']
	    	},
	    	{
	    		label: 'URA :',
	    		text: ['Gideon Aries Burgonio', 'Roinand Aguila']
	    	}
	    ],
	    projectLeaders: ['Project 1, Dr. Felino Lansigan, Project Leader'],
	    mediaLink: '/Services/integrated-pest-management.JPG',
	    mediaType: 'image',
	    mediasubtext: 'The application is still under development.',
	    mediasubtextlink: '',
	    col1Title: '',
	...
	Services.insert({
	    ...
	    projectLeaders: ['Project 2, Dr. Art Salazar, Project Leader'],
	    mediaLink: 'https://www.youtube.com/embed/LgyYBLmmJkA?feature=oembed',
	    mediaType: 'youtube-video',
	...
	Services.insert({
	    ...
	    projectLeaders: ['Project 2, Dr. Art Salazar, Project Leader'],
	    mediaLink: '/Services/suitability-copy-2.png',
	    mediaType: 'image',
	    ...
	    col1Title: 'The Challenge',
	    col1Text: '<p>Knowing what and where to plant are important considerations if you want to maximize your productivity and yield. It is also important to identify the parts of the country which are feasible to plant so that the policy makers and the local government unit can be guided on the agricultural programs that they will plan.</p>',
	    col2Title: 'Solutions',
	    col2Text: '<p>The SARAI Suitability Maps can be used to identify the different locations of the country which are highly suitable, moderately suitable, and marginally suitable for its initial six crops. By identifying these areas, resources will not be put to waste and farmers can attain more yield.</p>',
	    share: [
	        {
	            class_name: 'fb',
	...
	Services.insert({
	    ...
	    info: [
	    	...
	    	{
	    		label: 'Experts :',
	    		text: ['Engr. Moises Dorado, CEAT UPLB', 'Prof. Vicente Ballaran, CEAT, UPLB']
	    	},
	    	{
	    		label: 'URA :',
	    		text: ['Leo Viado', 'Jerome Suarez']
	    	},
	    	{
	    		label: 'Project 1, Dr. Felino Lansigan, Project Leader',
	    		text: [
	    ...
	    projectLeaders: ['Project 2, Dr. Art Salazar, Project Leader'],
	    mediaLink: '/Services/vulver2-2.png',
	    mediaType: 'image',
	    mediasubtext: 'View vulnerability maps',
	    mediasubtextlink: 'http://sarai.ph/index.php/vulnerability-maps/',
	    col1Title: '',
	    col1Text: '',
	    col2Title: '',
	    col2Text: '',
	    share: [
	        {
	            class_name: 'fb',
	            href: 'http://www.facebook.com/sharer.php?u=http://sarai.ph/?tcsn_portfolio=vulnerability-maps',
	            img: '/footer-icons/fb.png',
	            sort: 1
	        },
	        {
	            class_name: 'twt',
	            href: 'http://twitter.com/home?status=Vulnerability%20Maps%20http://sarai.ph/?tcsn_portfolio=vulnerability-maps',
	            img: '/footer-icons/twitter.png',
	            sort: 2
	        },
	        {
	            class_name: 'gp',
	            href: 'http://google.com/bookmarks/mark?op=edit&bkmk=http://sarai.ph/?tcsn_portfolio=vulnerability-maps',
	            img: '/footer-icons/googleplus.png',
	            sort: 3
	        },
	        {
	            class_name: 'li',
	            href: 'http://linkedin.com/shareArticle?url=http://sarai.ph/?tcsn_portfolio=vulnerability-maps',
	            img: '/footer-icons/linkedin.png',
	            sort: 4
	        },
	        {
	            class_name: 'pnt',
	            href: 'http://pinterest.com/pin/create/button/?url=http%3A%2F%2Fsarai.ph%2F%3Ftcsn_portfolio%3Dvulnerability-maps&description=Vulnerability%20Maps&media=http%3A%2F%2Fsarai.ph%2Fwp-content%2Fuploads%2F2016%2F03%2Fvulver2.png',
	            img: '/footer-icons/pinterest.png',
	            sort: 5
	        },
	        {
	            class_name: 'ml',
	            href: 'mailto:?subject=Vulnerability%20Maps&body=http://sarai.ph/?tcsn_portfolio=vulnerability-maps',
	            img: '/footer-icons/mail.png',
	            sort: 6
	        }
	    ],
